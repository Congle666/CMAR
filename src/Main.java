...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ------------------------------------------------------------------
        // Step 3 & 4: Mine frequent patterns and emit CARs directly (CR-tree)
        // ------------------------------------------------------------------
        System.out.println("[3] Mining frequent patterns on CR-tree "
        ...
        System.out.println("    Emitted " + candidates.size() + " candidate CARs (directly from CR-tree mining).");
